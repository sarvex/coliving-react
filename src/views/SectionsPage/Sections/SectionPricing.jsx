...
function SectionPricing({ ...props }) {
  ...
  return (
    <div className='cd-section' {...rest}>
        ...
        <div className={classes.container}>
          ...
          <GridContainer>
            <GridItem xs={12} sm={6} md={6} lg={3}>
              <Card pricing plain>
                <CardBody pricing plain>
                  <h6 className={`${classes.cardCategory} ${classes.marginBottom20}`}>Freelancer</h6>
            ...
            <GridItem xs={12} sm={6} md={6} lg={3}>
              <Card pricing raised>
                <CardBody pricing>
                  <h6 className={`${classes.cardDescription} ${classes.marginBottom20}`}>SMALL COMPANY</h6>
                  <div className={classes.icon}>
            ...
            <GridItem xs={12} sm={6} md={6} lg={3}>
              <Card pricing plain>
                <CardBody pricing plain>
                  <h6 className={`${classes.cardCategory} ${classes.marginBottom20}`}>MEDIUM COMPANY</h6>
                  <div className={classes.icon}>
            ...
            <GridItem xs={12} sm={6} md={6} lg={3}>
              <Card pricing plain>
                <CardBody pricing plain>
                  <h6 className={`${classes.cardCategory} ${classes.marginBottom20}`}>ENTERPRISE</h6>
                  <div className={classes.icon}>
      ...
      <div className={classes.pricing}>
        <div className={classes.container}>
          ...
          <GridContainer>
            ...
            <GridItem xs={12} sm={4} md={4}>
              <Card pricing raised background style={{ backgroundImage: `url(${cardBlog3})` }}>
      ...
      {/* Pricing 2 END */}
      {/* Pricing 3 START */}
      <div className={`${classes.pricing} ${classes.section}`} style={{ backgroundImage: `url(${city})` }}>
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={6} md={6} className={`${classes.mlAuto} ${classes.mrAuto} ${classes.textCenter}`}>
              <h2 className={classes.title}>Pick the best plan for you</h2>
          ...
          <GridContainer>
            <GridItem xs={12} sm={4} md={4} className={`${classes.mlAuto} ${classes.mrAuto}`}>
              ...
              <p className={classes.description}>
                You have Free Unlimited Updates and Premium Support on each package. You also have 20 days to request a
                refund if you're not happy with your purchase.
              </p>
            </GridItem>
          </GridContainer>
          <GridContainer>
