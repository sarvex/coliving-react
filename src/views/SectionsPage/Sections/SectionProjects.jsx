    ...
    <div className='cd-section' {...rest}>
      ...
      <div className={classes.projects}>
        <div className={classes.container}>
          ...
          <GridContainer>
            ...
            <GridItem xs={12} sm={6} md={6}>
              <Card raised background style={{ backgroundImage: `url(${cardBlog3})` }}>
                <CardBody background>
          ...
          <GridContainer>
            <GridItem xs={12} sm={4} md={4}>
              <Card plain className={classes.card2}>
                <a href='https://www.creative-tim.com/product/material-kit-react' target='_blank'>
                  <CardHeader image plain>
                    <img
                      src='https://s3.amazonaws.com/creativetim_bucket/products/83/original/opt_mk_react_thumbnail.jpg?1525851474'
                      alt='...'
                    />
                    <div
                ...
                <CardBody plain>
                  <a href='https://www.creative-tim.com/product/material-kit-react' target='_blank'>
                    <h4 className={classes.cardTitle}>Material Kit Free React</h4>
                  </a>
                  <h6 className={classes.description}>FREE UI KIT</h6>
                  <p className={`${classes.description} ${classes.marginTop20}`}>
                    Material Kit is a Free Material-UI Kit with a fresh, new design inspired by Google's material
                    design. It's a great pleasure to introduce to you the material concepts in an easy to use and
            ...
            <GridItem xs={12} sm={4} md={4}>
              <Card plain className={classes.card2}>
                <a href='https://www.creative-tim.com/product/light-bootstrap-dashboard-pro-react' target='_blank'>
                  <CardHeader image plain>
                    <img
                ...
                <CardBody plain>
                  ...
                  <p className={`${classes.description} ${classes.marginTop20}`}>
                    Light Bootstrap Dashboard PRO is a Bootstrap 3 Admin Theme designed to look simple and beautiful.
                    Forget about boring dashboards and grab yourself a copy to kickstart new project!
                  </p>
                </CardBody>
              </Card>
            </GridItem>
            <GridItem xs={12} sm={4} md={4}>
              <Card plain className={classes.card2}>
                <a href='https://www.creative-tim.com/product/now-ui-dashboard-pro-react' target='_blank'>
                  <CardHeader image plain>
                    <img
                ...
                <CardBody plain>
                  ...
                  <h6 className={classes.description}>Premium Template</h6>
                  <p className={`${classes.description} ${classes.marginTop20}`}>
                    Now UI Dashboard React is an admin dashboard template designed by Invision and coded by Creative
                    Tim. It is built on top of Reactstrap, using Now UI Dashboard and it is fully responsive.
                  </p>
                </CardBody>
              </Card>
            </GridItem>
      ...
      <div className={`${classes.projects} ${classes.projects4}`}>
        <div className={classes.container}>
          ...
          <GridContainer>
            <GridItem xs={12} sm={5} md={5} className={classes.mlAuto}>
              <Card background className={classes.card4} style={{ backgroundImage: `url(${cardProject2})` }}>
          ...
          <GridContainer>
            ...
            <GridItem xs={12} sm={5} md={5} className={classes.mrAuto}>
              <Card background className={classes.card4} style={{ backgroundImage: `url(${cardProject5})` }}>
                <CardBody background className={classes.cardBody4}>
