...
function SectionTestimonials({ ...props }) {
  ...
  return (
    <div className='cd-section' {...rest}>
      ...
      <div className={`${classes.testimonials} ${classes.sectionImage}`} style={{ backgroundImage: `url(${dg2})` }}>
          ...
          <GridContainer>
            <GridItem xs={12} sm={6} md={6} className={`${classes.mlAuto} ${classes.mrAuto} ${classes.textCenter}`}>
              ...
              <h5 className={classes.description}>
                You need more information? Check what other persons are saying about our product. They are very happy
                with their purchase.
              </h5>
            </GridItem>
          </GridContainer>
              ...
              <Card testimonial className={classes.card1}>
                ...
                <CardBody>
                  <h5 className={classes.cardDescription}>
                    Your products, all the kits that I have downloaded from your site and worked with are sooo cool! I
                    love the color mixtures, cards... everything. Keep up the great work!
                  </h5>
                </CardBody>
              ...
              <Carousel {...settings}>
                <div>
                  <Card testimonial plain className={classes.card2}>
                    ...
                    <CardBody plain>
                      <h5 className={classes.cardDescription}>
                        "I speak yell scream directly at the old guard on behalf of the future. I gotta say at that time
                        I’d like to meet Kanye I speak yell scream directly at the old guard on behalf of the future. My
                        brother Chance!!!
                        <br />
                ...
                <div>
                  <Card testimonial plain className={classes.card2}>
                    ...
                    <CardBody plain>
                      <h5 className={classes.cardDescription}>
                        "Thank you Anna for the invite thank you to the whole Vogue team Called I Miss the Old Kanye At
                        the God's last game Chop up the soul Kanye. I promise I will never let the people down. I want a
                        better life for all!!! Pablo Pablo Pablo Pablo! Thank you Anna for the invite thank you to the
                        whole Vogue team."
                      </h5>
            ...
            <GridItem xs={12} sm={4} md={4}>
              <Card testimonial plain>
                ...
                <CardBody plain>
                  ...
                  <h5 className={classes.cardDescription}>
                    "I speak yell scream directly at the old guard on behalf of the future. I gotta say at that time I’d
                    like to meet Kanye I speak yell scream directly at the old guard on behalf of the future."
                  </h5>
                </CardBody>
              </Card>
            </GridItem>
            <GridItem xs={12} sm={4} md={4}>
              <Card testimonial plain>
                ...
                <CardBody plain>
                  ...
                  <h5 className={classes.cardDescription}>
                    "I promise I will never let the people down. I want a better life for all!!! Pablo Pablo Pablo
                    Pablo! Thank you Anna for the invite thank you to the whole Vogue team It wasn’t any Kanyes I love
                    Rick Owens’ bed design but the back is too high for the beams and angle of the ceiling"
                  </h5>
                </CardBody>
              </Card>
            </GridItem>
              ...
              <Card testimonial plain>
                ...
                <CardBody plain>
                  ...
                  <h5 className={classes.cardDescription}>
                    ...
                    compound... Royère doesn't make a Polar bear bed but the Polar bear. This is a very nice testimonial
                    about this company."
                  </h5>
                </CardBody>
              </Card>
