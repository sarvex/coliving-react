...
function SectionFeatures({ ...props }) {
  ...
  return (
    <div className='cd-section' {...rest}>
            ...
            <GridItem xs={12} sm={4} md={4}>
              <InfoArea
                ...
                description={
                  <span>
                    <p>
                      The moment you use Material Kit, you know you’ve never felt anything like it. With a single use,
                      this powerfull UI Kit lets you do more than ever before.
                    </p>
      ...
      {/* Feature 5 START */}
      <div className={classes.features5} style={{ backgroundImage: `url(${bg9})` }}>
        <GridContainer>
          <GridItem xs={12} sm={8} md={8} className={`${classes.mlAuto} ${classes.mrAuto} ${classes.textCenter}`}>
            <h2 className={classes.title}>Your life will be much easier</h2>
          </GridItem>
