                ...
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={7} md={7}>
                    ...
                    <p className={classes.description1}>
                      ...
                      a traditional boxed software company selling licenses. Today, it’s moving to a subscription model.
                  ...
                  <Card plain blog>
                    ...
                    <CardBody plain>
                      ...
                      <p className={classes.description}>
                        ...
                        recently a traditional boxed software company selling licenses.
                        <a href='#pablo' onClick={(e) => e.preventDefault()}>
                          {' '}
                          Read More{' '}
                        </a>
            ...
            <GridItem xs={12} sm={8} md={8} className={`${classes.mlAuto} ${classes.mrAuto}`}>
              ...
              <Card plain blog className={classes.card4}>
                <CardHeader image plain>
                  ...
                  <div className={classes.coloredShadow} style={{ backgroundImage: `url(${bg5})`, opacity: '1' }} />
                </CardHeader>
                <CardBody plain>
                  <Info>
                  ...
                  <h5 className={classes.description}>
                    ...
                    like Kanye loves Kanye I love Rick Owens’ bed design but the back is too high for the beams and
                    angle of the ceiling I also wanted to point out that it’s the first album to go number 1 off of
                    streaming...
                  </h5>
