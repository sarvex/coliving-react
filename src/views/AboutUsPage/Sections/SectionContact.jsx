        ...
        <GridContainer>
          <GridItem md={8} sm={8} className={classNames(classes.mrAuto, classes.mlAuto)}>
            ...
            <h4 className={classNames(classes.description, classes.textCenter)}>
              ...
              us about any further collaboration. We will get back to you in a couple of hours.
            </h4>
            <form>
              <GridContainer>
                <GridItem md={4} sm={4}>
              ...
              <GridContainer>
                <GridItem md={4} sm={4} className={classNames(classes.mrAuto, classes.mlAuto, classes.textCenter)}>
