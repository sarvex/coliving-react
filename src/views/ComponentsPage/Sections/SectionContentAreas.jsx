      ...
      <div {...rest} className='cd-section' id='contentAreas'>
        ...
        <div id='tables'>
          ...
          <GridContainer>
            ...
            <GridItem xs={12} sm={10} md={8} className={`${classes.mrAuto} ${classes.mlAuto}`}>
              <h4>
              ...
              <Table
                ...
                tableData={[
                  ...
                  ['4', 'Mike Monday', 'Marketing', '2013', '€ 49,990', roundButtons],
                  ['5', 'Paul Dickens', 'Communication', '2015', '€ 69,201', fillButtons],
                ]}
              ...
              <Table
                ...
                tableData={[
                  [
                    ...
                    <Tooltip id='close1' title='Remove item' placement='left' classes={{ tooltip: classes.tooltip }}>
                  ...
                  [
                    ...
                    <Tooltip id='close2' title='Remove item' placement='left' classes={{ tooltip: classes.tooltip }}>
                      <Button link className={classes.actionButton}>
                        <Close />
                      </Button>
                    </Tooltip>,
                  ...
                  [
                    ...
                    <Tooltip id='close3' title='Remove item' placement='left' classes={{ tooltip: classes.tooltip }}>
                      <Button link className={classes.actionButton}>
                        <Close />
                      </Button>
                    </Tooltip>,
        ...
        <div id='comments'>
          ...
          <GridContainer>
            <GridItem xs={12} sm={8} md={8} className={`${classes.mlAuto} ${classes.mrAuto}`}>
              <div>
                <h3 className={`${classes.title} ${classes.textCenter}`}>10 Comments</h3>
                <Media
                  avatar={avatar}
                  title={
                    <span>
                  ...
                  body={
                    <span>
                      <p>
                        Chance too good. God level bars. I'm so proud of @LifeOfDesiigner #1 song in the country. Panda!
                        Don't be scared of the truth because we need to restart the human foundation in truth I stand
                        with the most humility. We are so blessed!
                      </p>
                      <p>
                        All praises and blessings to the families of people who never gave up on dreams. Don't forget,
                        You're Awesome!
                      </p>
                    </span>
                  }
                ...
                <Media
                  ...
                  body={
                    <span>
                      <p>
                        Hello guys, nice to have you on the platform! There will be a lot of great stuff coming soon. We
                  ...
                  innerMedias={[
                    <Media
                      ...
                      body={
                        <span>
                          <p>
                            Hello guys, nice to have you on the platform! There will be a lot of great stuff coming
                            soon. We will keep you posted for the latest news.
                          </p>
                          <p>Don't forget, You're Awesome!</p>
                        </span>
                      }
