            ...
            <GridItem xs={12} sm={6} md={6}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={6} md={6} lg={4}>
                  <Button block round onClick={() => this.handleClickOpen('classicModal')}>
                    <LibraryBooks />
                    Classic
                  </Button>
                  <Dialog
                ...
                <GridItem xs={12} sm={6} md={6} lg={4}>
                  {/* BUTTON NOTICE MODAL */}
                  <Button block round onClick={() => this.handleClickOpen('noticeModal')}>
                  ...
                  <Dialog
                    ...
                    <DialogContent id='notice-modal-slide-description' className={classes.modalBody}>
                      <Instruction
                        ...
                        text={
                          <span>
                            ...
                            <a href='https://www.creative-tim.com/'>Creative Tim</a>. You can choose a social network or
                            go for the classic version, whatever works best for you.
                          </span>
                        }
                        image={dg1}
                      ...
                      />
                      <p>
                        If you have more questions, don't hesitate to contact us or send us a tweet @creativetim. We're
                        here to help!
                      </p>
                    </DialogContent>
                ...
                <GridItem xs={12} sm={6} md={6} lg={4}>
                  {/* BUTTON SMALL MODAL */}
                  <Button block round onClick={() => this.handleClickOpen('smallModal')}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={6} md={6} lg={6}>
                  {/* BUTTON LOGIN MODAL */}
                  <Button block round onClick={() => this.handleClickOpen('loginModal')}>
                    <AccountCircle /> Login
                  </Button>
                  {/* LOGIN MODAL START */}
                  <Dialog
                ...
                <GridItem xs={12} sm={6} md={6} lg={6}>
                  {/* BUTTON SIGNUP MODAL */}
                  <Button block round onClick={() => this.handleClickOpen('signupModal')}>
                    <Assignment /> Signup
                  </Button>
                  {/* SIGNUP MODAL START */}
                  <Dialog
