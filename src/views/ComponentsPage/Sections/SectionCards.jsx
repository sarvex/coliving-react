                    ...
                    <Card color='info'>
                      ...
                      <CardFooter>
                        <div className={classes.authorWhite}>
                          <a href='#pablo' onClick={(e) => e.preventDefault()}>
                            <img src={avatar} alt='...' className={`${classes.imgRaised} ${classes.avatar}`} />
                    ...
                    <Card>
                      ...
                      <CardFooter>
                        <div className={classes.author}>
                          <a href='#pablo' onClick={(e) => e.preventDefault()}>
                            <img src={christian} alt='...' className={`${classes.imgRaised} ${classes.avatar}`} />
                            <span>Lord Alex</span>
                          </a>
                        </div>
                  ...
                  <GridItem xs={12} sm={6} md={6} lg={4}>
                    ...
                    <Card color='success'>
                      <CardBody color>
                        ...
                        <div className={`${classes.stats} ${classes.justifyContentCenter}`}>
                    ...
                    <Card profile>
                      <CardHeader image>
                        <a href='#pablo' onClick={(e) => e.preventDefault()}>
                          ...
                          <div className={classes.cardTitleAbsolute}>Tania Andrew</div>
                        </a>
                        <div
                          className={classes.coloredShadow}
                          style={{
                  ...
                  <GridItem xs={12} sm={4} md={4}>
                    <Card profile>
                      ...
                      <CardBody>
                        ...
                        <h6 className={`${classes.cardCategory} ${classes.cardDescription}`}>CEO / CO-FOUNDER</h6>
                      </CardBody>
                      <CardFooter profile className={classes.justifyContentCenter}>
            ...
            <div>
              <div className={classes.container}>
                ...
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={6} md={6}>
                    <Card background style={{ backgroundImage: `url(${cardBlog3})` }}>
                      <CardBody background>
              ...
              <div className={classes.container}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={6} md={6} lg={3}>
                    <Card pricing>
                      <CardBody pricing>
                        <h6 className={`${classes.cardCategory} ${classes.cardDescription} ${classes.marginBottom20}`}>
                          SMALL COMPANY
                        </h6>
                  ...
                  <GridItem xs={12} sm={6} md={6} lg={3}>
                    <Card pricing background style={{ backgroundImage: `url(${cardBlog3})` }}>
                    ...
                    <Card background className={classes.cardRotate}>
                      <div
                        ...
                        <CardBody background className={classes.cardBodyRotate}>
                          ...
                          <a href='#pablo' onClick={(e) => e.preventDefault()}>
                            <h3 className={classes.cardTitleWhite}>This Background Card Will Rotate on Hover</h3>
                          </a>
                          <p className={classes.cardDescriptionWhite}>
                            Don't be scared of the truth because we need to restart the human foundation in truth And I
                            love you like Kanye loves Kanye I love Rick Owens’ bed design but the back is...
                    ...
                    <Card className={classes.cardRotate}>
                      <div className={classes.front}>
                        <CardBody className={classes.cardBodyRotate}>
                          <Success>
                            <h5 className={classes.cardCategorySocial}>
                              <i className='far fa-newspaper' /> Manual Rotating Card
                            </h5>
                          </Success>
                          <h4 className={classes.cardTitle}>
                            <a href='#pablo' onClick={(e) => e.preventDefault()}>
                      ...
                      <div className={classes.back}>
                        <CardBody className={classes.cardBodyRotate}>
                          ...
                          <br />
                          <Button link onClick={() => this.setState({ activeRotate1: '' })}>
                            <Refresh /> Back...
                          </Button>
                        </CardBody>
                      </div>
            ...
            <GridContainer>
              <GridItem xs={12} sm={7} md={7}>
                <div className={classes.title}>
                  ...
                  <h4>
                    Material Kit PRO is coming with the famous colored shadows. That means each image from the cards is
                    getting an unique color shadow. You don't have to do anything to activate them, just enjoy the new
