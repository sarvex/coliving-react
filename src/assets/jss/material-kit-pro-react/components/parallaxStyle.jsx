...
const parallaxStyle = {
  ...
  primaryColor: {
    ...
    '&:after': {
      background: `linear-gradient(60deg,rgba(${hexToRgb(primaryColor[4])},.56),rgba(${hexToRgb(
        primaryColor[5],
      )},.95))`,
    },
    '&:after,&:before': {
  ...
  successColor: {
    ...
    '&:after': {
      background: `linear-gradient(60deg,rgba(${hexToRgb(successColor[6])},.56),rgba(${hexToRgb(
        successColor[7],
      )},.95))`,
    },
    '&:after,&:before': {
  ...
  warningColor: {
    ...
    '&:after': {
      background: `linear-gradient(60deg,rgba(${hexToRgb(warningColor[6])},.56),rgba(${hexToRgb(
        warningColor[7],
      )},.95))`,
    },
    '&:after,&:before': {
