...
const buttonStyle = {
  ...
  secondary: {
    ...
    boxShadow: `0 2px 2px 0 rgba(${hexToRgb(secondaryColor[0])},.14), 0 3px 1px -2px rgba(${hexToRgb(
      secondaryColor[0],
    )},.2), 0 1px 5px 0 rgba(${hexToRgb(secondaryColor[0])},.12)`,
    '&:hover,&:focus': {
      boxShdow: `0 14px 26px -12px rgba(${hexToRgb(secondaryColor[0])},.42), 0 4px 23px 0 rgba(${hexToRgb(
        blackColor,
      )},.12), 0 8px 10px -5px rgba(${hexToRgb(secondaryColor[0])},.2)`,
      color: `rgba(${hexToRgb(blackColor)},.87)`,
