    ...
    <List className={`${classes.list} ${classes.mlAuto}`}>
      ...
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          buttonIcon={ViewDay}
          dropdownList={[
            <Link to='/sections#headers' className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'headers')}>
              <Dns className={classes.dropdownIcons} /> Headers
            </Link>,
            <Link to='/sections#features' className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'features')}>
            ...
            <Link to='/sections#projects' className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'projects')}>
              <Assignment className={classes.dropdownIcons} /> Projects
            </Link>,
            <Link to='/sections#pricing' className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'pricing')}>
            ...
            <Link to='/sections#contacts' className={classes.dropdownLink} onClick={(e) => smoothScroll(e, 'contacts')}>
